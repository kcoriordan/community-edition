...
It is also recommended that the reader familiarize themselves with the [working with packages](package-management) documention as we will be using packages extensively in this procedure.
